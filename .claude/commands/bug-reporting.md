...
if [ ! -f ".claude/.framework-config" ]; then
  echo "[WARN]  Framework config not found. Run 'start' first to initialize."
  exit 1
fi
...
echo "[OK] Bug reporting disabled"
echo ""
...
echo ""
echo "========================================"
echo "[LOCK] Bug Reporting Status"
echo "========================================"
echo ""
...
echo "[LAB] Testing bug reporting system..."
echo ""
...
echo "[OK] Test report created: $LOG_FILE"
echo ""
